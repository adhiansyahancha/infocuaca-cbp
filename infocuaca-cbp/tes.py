...
def data_persiapa1(kode):
    return {
        ...
        "t0": data[kode]["parameter"][5]["timerange"][0]["value"][1]["#text"] + "°C",
        "t1": data[kode]["parameter"][5]["timerange"][1]["value"][1]["#text"] + "°C",
        "t2": data[kode]["parameter"][5]["timerange"][2]["value"][1]["#text"] + "°C",
