...
def data_persiapa1(kode):
    return {
        ...
        "t0": data[kode]["parameter"][5]["timerange"][0]["value"][1]["#text"],
        "t1": data[kode]["parameter"][5]["timerange"][1]["value"][1]["#text"],
        "t2": data[kode]["parameter"][5]["timerange"][2]["value"][1]["#text"],
        "t3": data[kode]["parameter"][5]["timerange"][3]["value"][1]["#text"],
